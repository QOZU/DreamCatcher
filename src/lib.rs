...
#[derive(Debug)]
pub struct DreamCatcherProcessor {
    verbose: bool,
    processed_count: usize,
}

impl DreamCatcherProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting DreamCatcher processing");
    
    let mut processor = DreamCatcherProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = DreamCatcherProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = DreamCatcherProcessor::new(false);
